...
hora_fim = time()
print(f"EDSON PEREIRA é encontrado na posição: {pos1}")
...
hora_fim = time()
print(f"MARIA FERREIRA é encontrado na posição: {pos2}")
print(f"Tempo gasto: {(hora_fim - hora_ini) * 1000}ms\n")
...
hora_fim = time()
print(f"VALDIR SILVA é encontrado na posição: {pos3}")
print(f"Tempo gasto: {(hora_fim - hora_ini) * 1000}ms\n")
...
hora_fim = time()
print(f"GILCICLEIDE GARCIA é encontrado na posição: {pos4}")
print(f"Tempo gasto: {(hora_fim - hora_ini) * 1000}ms\n")
